...
export default function PengaduanStatusCreate() {
  //title page
  document.title = "Create Status - SIPEVO";
  ...
  const storeStatus = async (e) => {
    ...
    //sending data
    await Api.post("/api/admin/pengaduan/status", formData, {
      //header
      headers: {
        //header Bearer + Token
          ...
          <div className="col-md-12">
            ...
            <div className="card border-0 shadow">
              <div className="card-body">
                <h6>
                  <i className="fa fa-folder"></i> Create Status
                </h6>
                <hr />
